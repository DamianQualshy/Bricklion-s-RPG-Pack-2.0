...
## 1.2.3
As it is an old-format Texture Pack, it will work properly up to version 1.2.3. You can technically still use it up to 13w23b or 1.5.2, but the new blocks (and possibly items) will be missing their textures.
